...
#    Actual data: http://py4e-data.dr-chuck.net/comments_1594623.json (Sum ends with 72)

# You do not need to save these files to your folder since your program will read the data directly from the
#  URL. Note: Each student will have a distinct data url for the assignment - so only use your own data url for analysis.
...
# to look at geoxml.py to see how to prompt for a URL and retrieve data from a URL.
